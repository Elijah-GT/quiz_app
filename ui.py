...
class QuizInterface:
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.window.after(1000,self.show_final_score)
    ...
    def give_feedback(self, is_right):
        ...
        self.window.after(1000, self.get_next_question)#Hold color for 1 second then go to next question

    def show_final_score(self):
        self.canvas.itemconfig(self.question_text, text=f"SCORE:{self.quiz.score}/{AMOUNT}")